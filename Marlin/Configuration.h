...
#define HOTEND_OFFSET_X { 0.0, 42.50 } // (mm) relative X-offset for each nozzle
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 355.5556, 355.5556, 10240, 355.5556 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 1400, 20 }
